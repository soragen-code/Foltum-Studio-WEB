...
async function main() {
  ...
  const scenes = [
    { videoUrl: `${base}/scene-1-1788827437614.mp4` },
    { videoUrl: `${base}/scene-2-1788827454039.mp4` },
    { videoUrl: `${base}/scene-3-1788827452127.mp4` },
  ];
  ...
  console.log("== assembleEpisodeLocally test (no subtitles) ==");
