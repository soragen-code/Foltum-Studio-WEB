...
function unitStage55() {
  ...
  assert.match(FULL_BODY_PROPORTIONS, /HALF of the total height/i);
  ...
  assert.match(auto, /HALF of the total/i);
  ...
  assert.match(FULL_BODY_PROPORTIONS, /EXACTLY HALF of the total height/i);
