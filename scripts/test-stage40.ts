...
function syncTail() {
  ...
  const n = normalizeTestSceneResult({ projectTitle: "**Пирс**", title: "Спор", locationDesc: "EXT pier", videoPrompt: prompt9, dialogue: 'A: "hi"', action: "They argue on the pier.", durationSec: 3, endState: scripted });
