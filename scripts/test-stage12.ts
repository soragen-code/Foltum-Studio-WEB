...
(async () => {
  ...
  ok(sceneScriptSchema.parse({ number: 1, shotType: "med", locationDesc: "room", action: "they talk", dialogue: "A: hi", videoPrompt: "x".repeat(41), endState: "Anna stands by the window, back to the door, hands on the sill, medium shot from the doorway." }).sceneKind === "dialogue", "sceneScriptSchema defaults sceneKind to 'dialogue'");
