...
export const SCALE_DEPTH_RULE =
  ...
  "The cut list mixes SHOT SCALES: open every scene with a WIDE or ESTABLISHING beat that shows the room/street and how far it extends, use TWO-SHOTS and medium shots that keep the environment and the distance between characters visible, and reserve close-ups for short accents. " +
