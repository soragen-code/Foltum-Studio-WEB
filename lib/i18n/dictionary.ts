...
const ru: Dict = {
  ...
  'manual.videoRefsHint': 'Передаются как reference_images; упоминайте их в промпте как [Image1]…[Image4].',
...
const en: Dict = {
  ...
  'manual.videoRefsHint': 'Sent as reference_images; refer to them in the prompt as [Image1]…[Image4].',
