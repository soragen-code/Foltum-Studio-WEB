...
const ru: Dict = {
  ...
  'manual.firstFrameHint': 'Результат из плитки «Фото», загруженный файл или ссылка.',
  'manual.videoRefs': 'Референсы (до 4)',
...
const en: Dict = {
  ...
  'manual.firstFrameHint': 'The result from the Photo tile, an uploaded file or a link.',
  'manual.videoRefs': 'References (up to 4)',
