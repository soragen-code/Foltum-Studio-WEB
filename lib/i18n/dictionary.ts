...
const ru: Dict = {
  ...
  'manual.uploadDecodeFailed': 'Не удалось прочитать изображение. Попробуйте другой файл (PNG, JPEG или WebP).',
...
const en: Dict = {
  ...
  'manual.uploadDecodeFailed': 'Could not read the image. Try another file (PNG, JPEG or WebP).',
