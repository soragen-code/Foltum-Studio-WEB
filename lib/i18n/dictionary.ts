...
const ru: Dict = {
  ...
  'manual.loc.subtitle': 'Опишите пространство и четыре стены — сгенерируются 4 согласованных кадра (перёд → зад/лево/право). Сохраните локацию и используйте её как референс в генераторе видео.',
  'manual.loc.name': 'Название локации',
  'manual.loc.namePlaceholder': 'Например: Заброшенный склад',
  'manual.loc.description': 'Полное описание',
  ...
  'manual.loc.frontPlaceholder': 'что напротив камеры',
  'manual.loc.backPlaceholder': 'что позади',
  'manual.loc.leftPlaceholder': 'что слева',
  'manual.loc.rightPlaceholder': 'что справа',
...
const en: Dict = {
  ...
  'manual.loc.subtitle': 'Describe the space and its four walls — 4 consistent plates are generated (front → back/left/right). Save the location and reuse it as a reference in the video generator.',
  'manual.loc.name': 'Location name',
  'manual.loc.namePlaceholder': 'e.g. Abandoned warehouse',
  'manual.loc.description': 'Full description',
  ...
  'manual.loc.frontPlaceholder': 'what faces the camera',
  'manual.loc.backPlaceholder': 'what is behind',
  'manual.loc.leftPlaceholder': 'what is on the left',
  'manual.loc.rightPlaceholder': 'what is on the right',
