...
export function storyboardBoardsSystemPrompt(): string {
  return [
    ...
    "- Dialogue coverage: medium, close-up or over-the-shoulder speaker, alternating with reverse-shot listener or the next speaker. One shot per board; hard cut BETWEEN boards, no internal cuts. Keep the same side of the 180-degree axis, stable screen sides and partner eyelines, never face the audience. Off-screen partners still occupy the location: crop is NOT disappearance. Walking dialogue may track; stationary dialogue must not.",
