 ...
 */
export const DEFAULT_GRID_TEMPLATE = `Photorealistic storyboard sheet: 5 rows × 5 columns of equal PORTRAIT 9:16 panels (25 total), thin black borders, dark grey background, NO margins, NO labels, NO text of any kind inside or outside panels — only the panels edge to edge. Each panel is a cinematic photoreal still: real skin, real fabric, physically correct light, film grain. NOT drawing, NOT illustration.
