...
export function testSceneSystemPrompt(): string {
  return (
    ...
    `Return STRICT JSON: {"projectTitle": string, "title": string, "locationDesc": string, "sceneKind": "dialogue"|"narration"|"action", "videoPrompt": string, "dialogue": string, "action": string, "durationSec": int, "endState": string}. ` +
